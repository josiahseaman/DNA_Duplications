...
#/data2/SBCS-BuggsLab/Josiah/genevalidator-1.7.2-linux-x86_64/bin/genevalidator ../FRAX34/gffread_filtered_protein.fasta -d /data/SBCS-BuggsLab/Josiah/DNA_Duplications/GeMoMa-1.5/cds-parts.fasta -num_threads=1
# $genevalidator -d /data/SBCS-BuggsLab/Josiah/DNA_Duplications/GeMoMa-1.5/gene_validator/cds-parts.fasta -n 4 /data/SBCS-BuggsLab/Josiah/DNA_Duplications/GeMoMa-1.5/${name}/gffread_filtered_protein.fasta
