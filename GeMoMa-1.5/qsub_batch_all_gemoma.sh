...
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX02 ${ASSEMBLY}FRAX02_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX03 ${ASSEMBLY}FRAX03_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX04 ${ASSEMBLY}FRAX04_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX05 ${ASSEMBLY}FRAX05_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX06 ${ASSEMBLY}FRAX06_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX07 ${ASSEMBLY}FRAX07_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX08 ${ASSEMBLY}FRAX08_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX11 ${ASSEMBLY}FRAX11_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX12 ${ASSEMBLY}FRAX12_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX13 ${ASSEMBLY}FRAX13_800bp_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX14 ${ASSEMBLY}FRAX14_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX15 ${ASSEMBLY}FRAX15_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX16 ${ASSEMBLY}FRAX16_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX19 ${ASSEMBLY}FRAX19_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX20 ${ASSEMBLY}FRAX20_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX21 ${ASSEMBLY}FRAX21_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX23 ${ASSEMBLY}FRAX23_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX25 ${ASSEMBLY}FRAX25_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX26 ${ASSEMBLY}FRAX26_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX27 ${ASSEMBLY}FRAX27_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX28 ${ASSEMBLY}FRAX28_CLC_SSPACE_GAPCLOSER.fasta
qsub ${GEM_HOME}/gene_validator/validator_qsub.sh FRAX29 ${ASSEMBLY}FRAX29_CLC_SSPACE_GAPCLOSER.fasta
