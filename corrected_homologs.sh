...
#$ -pe smp 3                     # Request CPU cores
#$ -l h_rt=8:0:0                         # Request hours runtime (upto 240 hours)
...
-s /data/SBCS-BuggsLab/Josiah/DNA_Duplications/CAFE-4.2/data/corrected_orthologs/Species_tree_corrected_root_added_02_34.tre \
-t 3
