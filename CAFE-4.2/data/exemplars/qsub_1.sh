...
python ../cafe_tutorial/python_scripts/cafetutorial_clade_and_size_filter.py \
-i exemplar_filtered_OG_counts.txt -o exemplar_clade_filter.csv -s
...
cafe /data/SBCS-BuggsLab/Josiah/DNA_Duplications/CAFE-4.2/data/exemplars/run_internal_node_test.sh
...
python $REPORT_SCRIPT -i reports/internal_node_test.cafe -o reports/internal_node_test_summary
